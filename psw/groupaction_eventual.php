...
<body>
    ...
    <div  class="container animate__animated animate__fadeInDown animate__faster" id="contenido">
        <div class="divHeader container">
            <div class="header-section">
                <h2 class="title">Permisos Eventuales por <span>grupo</span></h2>
            </div>
            <div class="circCont">
        ...
        <form class="row g-2" id="formulario">
            <div class="col-md-6 position-relative" >
                ...
                <select class="form-select" id="permiso" required="" autocomplete="nope">
                    <option selected="" value="" disabled=""> Seleccione un permiso</option>
                </select>
            </div>
            <div class="col-md-6 position-relative" >
                <label for="Grupo" class="form-label">Grupo</label>
                <select class="form-select uppercase" id="grupo" required="">
                    <option selected="" value="" disabled=""> Seleccione un Grupo</option>
                </select>
            </div>
            <div class="col-md-12 position-relative" >
                <label for="empresa" class="form-label">Clientes</label>
                <select class="form-select" size="5" multiple aria-label="multiple select example" id="comandos_id">
            ...
            <div class="col-md-6 position-relative" >
                ...
                <input type="time" class="form-control"  id="hdesde" required="">
            </div>
            <div class="col-md-6 position-relative" >
            ...
            <div class="col-md-6 position-relative" >
                ...
                <input type="time" class="form-control"  id="hhasta" required="">
            </div>
        ...
        <form class="row g-2 " id="formularioReporte">
            <div class="col-md-12 position-relative" id="grupotipoReporte">
                <select class="form-select" id="formatoVer" required="">
  ...
  <script src="../../modulos/toastNotification/toastNotification.js" ></script>
    <script src="../../modulos/utilities/utilities.js" ></script>
  ...
  <script> 
    ...
    function generarReporte(animation= true){
        ...
        fetch("groupaction_eventual_cmd.php",{
            method:'POST',
            headers:{
        ...
        .then( res=>{
            ...
            if (res.ok) {
                let datosTabla = ["groupname","empresas","actionname","gae_fecha_desde", "gae_fecha_hasta","gae_fecha_alta"]
    ...
    function cargarSelects(){
        ...
        let dataBase = ["groups_cmd.php", "groupaction_eventual_cmd.php","accounts_cmd.php"];
        let selectId = ["grupo", "permiso","comandos_id"];
        let idOption = ["groupid", "actionid", "cliente_id"];
        let nameOption = ["groupname", "actionname", "cliente_nombre"];
    ...
    function agregarPermiso(){
        ...
        selects.forEach(select => {
            if (select.id != "comandos_id") {
                bodyValue += `&form_PermissionForm[${select.id}]=${select.options[select.selectedIndex].value}`;
            }
            else{
                let optionsSelected = getSelectValues("comandos_id");
                bodyValue += `&form_PermissionForm[comandos_id]=${optionsSelected}`
            }
        });
