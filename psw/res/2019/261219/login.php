<?php
  ...
  if ($FormElements['__error'] == "") {
      function dirsistema() {
          // devuelve el directorio raiz del sistema, devuelve megacontrol o megaweb
          $url = dirname(__FILE__);
          $array = explode('/',$url);
          foreach ($array as $k => $v) {
              if ($v == 'megacontrol') $resp="megacontrol";
              if ($v == 'usuariocontrol') $resp="megacontrol";
              if ($v == 'megaweb') $resp="megaweb";
              if ($v == 'usuario') $resp="megaweb";
          }
