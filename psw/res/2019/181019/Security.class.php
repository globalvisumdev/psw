...
,(select a.accountid_equivale
    ...
    from  accountcliente
    WHERE clienteid = '".$_SESSION['cliente_id']."' and accountid=".$account."
...
//              	$q1="select cm_modulo from cliente_modulo where cm_cliente = ".$_SESSION['cliente_id']." and cm_modulo='TAV' and cm_inactivo=0";
              	$q1="select if (cm_fecha_vto is null,'0000-00-00',cm_fecha_vto) cm_fecha_vto,date(now()) hoy from cliente_modulo
	     where cm_cliente= ".$_SESSION['cliente_id']."
		and cm_modulo='TAV'
	        and cm_serie=0
